  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans text-gray-900">
      ...
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto w-full">
        <div className="text-2xl font-black tracking-tighter">VURA<span className="text-blue-600">.</span></div>
        <button onClick={onStart} className="font-bold text-sm text-gray-500 hover:text-blue-600 transition">
          Skip to Designing
        </button>
      </nav>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 mt-10 mb-20">
        <div className="bg-blue-50 text-blue-700 px-4 py-1.5 rounded-full text-sm font-bold mb-8 flex items-center gap-2 animate-fade-in-up">
          <Sparkles size={16} />
        ...
        <p className="text-xl md:text-2xl text-gray-500 max-w-2xl mb-10 leading-relaxed text-pretty">
        ...
        <button 
          onClick={onStart}
          className="group relative px-8 py-4 bg-black text-white text-lg font-bold rounded-2xl hover:bg-gray-800 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center gap-3 overflow-hidden"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 max-w-5xl w-full text-left">
           ...
           />
           <FeatureCard 
              icon={<Hammer className="text-gray-700" />}
              title="Hanging Map"
...
const FeatureCard = ({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) => (
  <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100 hover:border-blue-100 hover:bg-blue-50/30 transition duration-300">
    <div className="mb-4 bg-white w-12 h-12 rounded-xl flex items-center justify-center shadow-sm text-xl">
      {icon}
    </div>
